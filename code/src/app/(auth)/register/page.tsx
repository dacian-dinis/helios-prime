        ...
        <div className="rounded-2xl border border-foreground/10 bg-foreground/5 p-8 shadow-xl backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="flex w-full items-center justify-center rounded-xl bg-accent py-3 text-sm font-bold text-black transition-all hover:bg-accent/90 hover:shadow-lg hover:shadow-accent/20 disabled:cursor-not-allowed disabled:opacity-70"
            >
              {isSubmitting ? (
